...
void main() {
  testWidgets('LoginScreen renders correctly and toggles state', (WidgetTester tester) async {
    ...
    await tester.tap(find.widgetWithText(TextButton, 'Pas encore de compte ? Créer un compte'));
